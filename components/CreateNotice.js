  ...
  render() {
    return (
      ...
      <Form style={{marginTop:20,marginLeft:20,marginRight:20,width:300}}>
            ...
            <Text style={{color:'white',fontSize:35}}>Create Notice</Text>
            </View>
           ...
           <View style={{marginTop:20}}>
                              ...
                              mode="datetime"
                              placeholder="Enter date and time for event"
            ...
            <View>
              <View style={{marginTop:20}}>
                 <DatePicker
                     ...
                     placeholder="Enter start date and time of registeration for event"
                     format="YYYY-MM-DD HH:MM:SS"
                     confirmBtnText="Confirm"
                     cancelBtnText="Cancel"
                     customStyles={{
        ...
        <View style={{marginTop:20}}>
               ...
               disabled={!this.state.isRegister}
               mode="datetime"
               placeholder="Enter end date and time of registeration for event"
             format="YYYY-MM-DD HH:MM:SS"
         confirmBtnText="Confirm"
           cancelBtnText="Cancel"
               customStyles={{
