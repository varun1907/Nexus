...
export default class GuestLecture extends React.Component {
      ...
      AsyncStorage.getItem('ACCESS_TOKEN').then((value) => {
        if (value == null){
           ...
           this.setState({
             ...
             return fetch('https://nexus.scriptguru.org/api/notices/type/guest_lecture',{
              method: 'GET',
              headers: {
  ...
  static navigationOptions = {
    drawerIcon:(
      <Icon name="zap" style={{color:'#e91e63',height:24,width:24,fontSize:25}}/>
    )
  }
