...
export default class Workshop extends React.Component {
      ...
      AsyncStorage.getItem('ACCESS_TOKEN').then((value) => {
        if (value == null){
           ...
           this.setState({
             ...
             return fetch('https://nexus.scriptguru.org/api/notices/type/workshop',{
              method: 'GET',
              headers: {
  ...
  static navigationOptions = {
    drawerIcon:(
      <Icon name="briefcase" style={{color:'#e91e63',height:24,width:24,fontSize:25}}/>
    )
  }
  ...
  render() {
    return (
      ...
      renderRow={(item) =>
        <ListItem style={{paddingTop:0,paddingBottom:0,paddingRight:0,paddingLeft:0,marginLeft:0,borderWidth:5,borderTopColor:'#673ab7'}}>
              ...
              <CardItem style={{marginBottom:0,paddingBottom:10}}>
                  ...
                  <View style={{justifyContent:'center',alignItems:'center',width:50,height:30,borderRadius:5,marginBottom:30,borderWidth:2,borderColor:'#f06292',marginRight:5}}>
